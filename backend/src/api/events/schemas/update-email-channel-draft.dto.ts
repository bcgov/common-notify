 ...
 * not included - it's toggled immediately and separately via UpdateEmailChannelActiveDto, and
 * is left untouched by a draft save. The row is always marked as a draft (`is_draft = true`).
 */
