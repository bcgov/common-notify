...
export class Template {
  ...
  /**
   * Body content type: 'markdown' (markdown→HTML) for email, 'text' (sent verbatim) for SMS.
   * Determines rendering behavior during template rendering. Null for MJML, which is
   * always compiled to HTML.
   */
