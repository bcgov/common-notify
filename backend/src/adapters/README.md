...
Templates can specify which engine (handlebars, mustache, etc.) to use via the optional `engine` field when creating or updating a template. If omitted, the consuming module's default engine is used.
